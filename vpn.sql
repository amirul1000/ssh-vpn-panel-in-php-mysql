...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2020 at 06:36 AM
...
--
-- Table structure for table `assigned_server`
--

CREATE TABLE `assigned_server` (
  `id` int(10) NOT NULL,
...
--
-- Dumping data for table `assigned_server`
--

INSERT INTO `assigned_server` (`id`, `users_id`, `server_id`) VALUES
(1, 9, 1);
...
INSERT INTO `payment` (`id`, `users_id`, `amount`, `active_date`, `end_date`) VALUES
(1, 9, '100.00', '2020-11-06', '2021-11-10'),
(2, 9, '100.00', '2020-11-06', '2021-11-10');
...
CREATE TABLE `server` (
  `id` int(10) NOT NULL,
  `name_server` varchar(127) DEFAULT NULL,
  `ip_address` varchar(127) DEFAULT NULL,
  `password` varchar(64) DEFAULT NULL,
  `location` varchar(64) DEFAULT NULL,
  `ISP` varchar(64) DEFAULT NULL,
  `price` decimal(10,2) DEFAULT NULL,
  `SSH_port` varchar(64) DEFAULT NULL,
  `dropbear_port` varchar(64) DEFAULT NULL,
  `squid_port` varchar(64) DEFAULT NULL,
  `VPN_port` varchar(64) DEFAULT NULL,
  `config_open_vpn` varchar(127) DEFAULT NULL,
  `squid_version` varchar(64) DEFAULT NULL,
  `Note` text
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `server` (`id`, `name_server`, `ip_address`, `password`, `location`, `ISP`, `price`, `SSH_port`, `dropbear_port`, `squid_port`, `VPN_port`, `config_open_vpn`, `squid_version`, `Note`) VALUES
(1, 'Server1', '67.90.78.0', '123', 'Singapore', 'Digital Ocean', '100.00', '22, 99', '80. 110', '3128, 1922', '443. 777', '', 'Version 3', 'Test');
...
--
-- Indexes for table `assigned_server`
--
ALTER TABLE `assigned_server`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `assigned_server`
--
ALTER TABLE `assigned_server`
